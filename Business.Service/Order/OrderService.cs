...
namespace Business.Service.Order
{
    ...
    {
        IOrderBatchBizManager _orderBatchBizManager;
        IBizManager<BS_Order_SalesOrder_Batch> _manager;
        public OrderService(IBizManager<BS_Order_SalesOrder_Batch> manager
            , IOrderBatchBizManager orderBatchBizManager
            )
        {
            _manager = manager;
        ...
        public ResultData<BS_Order_SalesOrder_BatchDto> UpdateBatch(BS_Order_SalesOrder_BatchDto item)
        {
            ...
            try
            {
                ...
                {
                    Utils.CopyProperty(item, itemToUpdate);
